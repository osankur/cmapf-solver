...
namespace cmarrt
{
  ...
  /**
 * @class CMARRT for the algorithm Connected Multi-agent RRT (Rapidly-exploring random tree)
 * */
  ...
  private:
    ...
    private:
      ...
      /**
 * @brief returns the random configuration (used then to compute the nearest configuration)
